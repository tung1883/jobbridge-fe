        ...
        <Modal title={job.title} onClose={onClose} wide>
            ...
            <div style={{ fontSize: "var(--text-md)", fontWeight: 600, marginBottom: "1.25rem", color: "var(--sage)" }}>
                ...
                {job.currency && job.min_salary ? (
                    <span style={{ fontSize: "var(--text-sm)", color: "var(--muted)", fontWeight: 400 }}> / year</span>
                ) : null}
            </div>
                    ...
                    <div>
                        ...
                        {companyInfo.website && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                style={{ fontSize: "var(--text-xs)", color: "var(--sage)", textDecoration: "none" }}
            ...
            {job.description && (
                <div style={{ marginBottom: "1.25rem" }}>
                    ...
                    <div style={{ fontSize: "var(--text-base)", lineHeight: 1.75, color: "var(--ink)", whiteSpace: "pre-line" }}>
                        {job.description}
                    </div>
                </div>
            )}
            ...
            {job.responsibilities && (
                <div style={{ marginBottom: "1.25rem" }}>
                    ...
                    <div style={{ fontSize: "var(--text-base)", lineHeight: 1.75, whiteSpace: "pre-line", color: "var(--muted)" }}>
                        {job.responsibilities}
                    </div>
                </div>
            )}
