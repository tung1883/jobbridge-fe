...
import { Alert, Spinner, EmptyState, LoadingPage, ConfirmModal, SalaryDisplay, DateDisplay } from "../shared.jsx"
        ...
        <div className="page-enter">
            ...
            {company && company.verification_status !== "verified" && (
                <Alert type="warn">
                    ...
                    <span
                        ...
                        role="button"
                        tabIndex={0}
                        onKeyDown={(e) => e.key === "Enter" && navigateTo("company")}
                    >
            ...
            {!loading && list.length === 0 && (
                <EmptyState
                    ...
                    action={
                        <button type="button" className="btn btn-primary" onClick={() => navigateTo("job-create")}>
                            Post a job
                        </button>
                    }
                />
                        ...
                        <div key={job.id} className="card-flat" style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
                            <div style={{ flex: 1, minWidth: "200px" }}>
                                ...
                                >
                                    ...
                                    <span>
                                        Posted <DateDisplay date={job.created_at} />
                                    </span>
                                </div>
                            </div>
