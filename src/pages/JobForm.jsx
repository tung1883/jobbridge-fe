            ...
            <div className="page-enter">
                ...
                <div className="card" style={{ maxWidth: 520, margin: "0 auto", textAlign: "center", padding: "3rem 2rem" }}>
                    ...
                    <p style={{ color: "var(--muted)", fontSize: "0.9rem", lineHeight: 1.7, marginBottom: "1.5rem" }}>
                        Your company needs to be verified before you can post jobs. Upload your business registration document in Company Profile —
    ...
    return (
        <div className="page-enter">
            <div className="page-header-row">
                ...
                <button type="button" className="btn btn-ghost" onClick={() => navigateTo("jobs-mine")}>
                    ← Back
                </button>
            </div>
            ...
            <div className="card form-card" style={{ maxWidth: 680, margin: "0 auto" }}>
                ...
                <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.75rem", marginTop: "0.5rem" }}>
                    <button type="button" className="btn btn-secondary" onClick={() => navigateTo("jobs-mine")}>
                        Cancel
                    </button>
