...
/** Schedule refresh ~60s before access JWT expires; call after login and after each successful refresh. */
...
export const jobs = {
  ...
  getMine: () => get("/jobs/my"),
  /**
   * @param {{ search?, location?, minSalary?, maxSalary?, currency?, type?, page?, limit? }} params
   */
  search: (params = {}) => {
...
export const savedJobs = {
  ...
  unsave: (jobId) => del(`/boomark/${jobId}/`),
};
